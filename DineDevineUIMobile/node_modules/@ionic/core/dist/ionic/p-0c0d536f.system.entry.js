 ...
 */System.register(["./p-629aa3fd.system.js","./p-8050b9b9.system.js","./p-939e0fa1.system.js","./p-8a308596.system.js","./p-815c2fba.system.js","./p-b4b4bb29.system.js","./p-479cdbf8.system.js","./p-ccdcb022.system.js","./p-0e94957a.system.js"],(function(t,r){"use strict";var e,i,n,s,o,a,u,c,f,h,l,d,v,b;return{setters:[function(t){e=t.r;i=t.h;n=t.H;s=t.f;o=t.d},function(t){a=t.j;u=t.k},function(t){c=t.b},function(t){f=t.f;h=t.g},function(t){l=t.r},function(t){d=t.a;v=t.b;b=t.h},function(){},function(){},function(){}],execute:function(){var m=":host([slot]){display:none;line-height:0;z-index:100}.reorder-icon{display:block}::slotted(ion-icon){font-size:dynamic-font(16px)}.reorder-icon{font-size:2.125rem;opacity:0.4}";var p=":host([slot]){display:none;line-height:0;z-index:100}.reorder-icon{display:block}::slotted(ion-icon){font-size:dynamic-font(16px)}.reorder-icon{font-size:1.9375rem;opacity:0.3}";var y=t("ion_reorder",function(){function t(t){e(this,t)}t.prototype.onClick=function(t){var r=this.el.closest("ion-reorder-group");t.preventDefault();if(!r||!r.disabled){t.stopImmediatePropagation()}};t.prototype.render=function(){var t=c(this);var r=t==="ios"?a:u;return i(n,{class:t},i("slot",null,i("ion-icon",{icon:r,lazy:false,class:"reorder-icon",part:"icon","aria-hidden":"true"})))};Object.defineProperty(t.prototype,"el",{get:function(){return s(this)},enumerable:false,configurable:true});return t}());y.style={ios:m,md:p};var w=".reorder-list-active>*{display:block;-webkit-transition:-webkit-transform 300ms;transition:-webkit-transform 300ms;transition:transform 300ms;transition:transform 300ms, -webkit-transform 300ms;will-change:transform}.reorder-enabled{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.reorder-enabled ion-reorder{display:block;cursor:-webkit-grab;cursor:grab;pointer-events:all;-ms-touch-action:none;touch-action:none}.reorder-selected,.reorder-selected ion-reorder{cursor:-webkit-grabbing;cursor:grabbing}.reorder-selected{position:relative;-webkit-transition:none !important;transition:none !important;-webkit-box-shadow:0 0 10px rgba(0, 0, 0, 0.4);box-shadow:0 0 10px rgba(0, 0, 0, 0.4);opacity:0.8;z-index:100}.reorder-visible ion-reorder .reorder-icon{-webkit-transform:translate3d(0,  0,  0);transform:translate3d(0,  0,  0)}";var g=t("ion_reorder_group",function(){function t(t){e(this,t);this.ionItemReorder=o(this,"ionItemReorder",7);this.lastToIndex=-1;this.cachedHeights=[];this.scrollElTop=0;this.scrollElBottom=0;this.scrollElInitial=0;this.containerTop=0;this.containerBottom=0;this.state=0;this.disabled=true}t.prototype.disabledChanged=function(){if(this.gesture){this.gesture.enable(!this.disabled)}};t.prototype.connectedCallback=function(){return __awaiter(this,void 0,void 0,(function(){var t,e,i;var n=this;return __generator(this,(function(s){switch(s.label){case 0:t=f(this.el);if(!t)return[3,2];e=this;return[4,h(t)];case 1:e.scrollEl=s.sent();s.label=2;case 2:i=this;return[4,r.import("./p-fa8d4788.system.js")];case 3:i.gesture=s.sent().createGesture({el:this.el,gestureName:"reorder",gesturePriority:110,threshold:0,direction:"y",passive:false,canStart:function(t){return n.canStart(t)},onStart:function(t){return n.onStart(t)},onMove:function(t){return n.onMove(t)},onEnd:function(){return n.onEnd()}});this.disabledChanged();return[2]}}))}))};t.prototype.disconnectedCallback=function(){this.onEnd();if(this.gesture){this.gesture.destroy();this.gesture=undefined}};t.prototype.complete=function(t){return Promise.resolve(this.completeReorder(t))};t.prototype.canStart=function(t){if(this.selectedItemEl||this.state!==0){return false}var r=t.event.target;var e=r.closest("ion-reorder");if(!e){return false}var i=x(e,this.el);if(!i){return false}t.data=i;return true};t.prototype.onStart=function(t){t.event.preventDefault();var r=this.selectedItemEl=t.data;var e=this.cachedHeights;e.length=0;var i=this.el;var n=i.children;if(!n||n.length===0){return}var s=0;for(var o=0;o<n.length;o++){var a=n[o];s+=a.offsetHeight;e.push(s);a.$ionIndex=o}var u=i.getBoundingClientRect();this.containerTop=u.top;this.containerBottom=u.bottom;if(this.scrollEl){var c=this.scrollEl.getBoundingClientRect();this.scrollElInitial=this.scrollEl.scrollTop;this.scrollElTop=c.top+j;this.scrollElBottom=c.bottom-j}else{this.scrollElInitial=0;this.scrollElTop=0;this.scrollElBottom=0}this.lastToIndex=k(r);this.selectedItemHeight=r.offsetHeight;this.state=1;r.classList.add(z);d()};t.prototype.onMove=function(t){var r=this.selectedItemEl;if(!r){return}var e=this.autoscroll(t.currentY);var i=this.containerTop-e;var n=this.containerBottom-e;var s=Math.max(i,Math.min(t.currentY,n));var o=e+s-t.startY;var a=s-i;var u=this.itemIndexForTop(a);if(u!==this.lastToIndex){var c=k(r);this.lastToIndex=u;v();this.reorderMove(c,u)}r.style.transform="translateY(".concat(o,"px)")};t.prototype.onEnd=function(){var t=this.selectedItemEl;this.state=2;if(!t){this.state=0;return}var r=this.lastToIndex;var e=k(t);if(r===e){this.completeReorder()}else{this.ionItemReorder.emit({from:e,to:r,complete:this.completeReorder.bind(this)})}b()};t.prototype.completeReorder=function(t){var r=this;var e=this.selectedItemEl;if(e&&this.state===2){var i=this.el.children;var n=i.length;var s=this.lastToIndex;var o=k(e);l((function(){if(s!==o&&(t===undefined||t===true)){var a=o<s?i[s+1]:i[s];r.el.insertBefore(e,a)}for(var u=0;u<n;u++){i[u].style["transform"]=""}}));if(Array.isArray(t)){t=S(t,o,s)}e.style.transition="";e.classList.remove(z);this.selectedItemEl=undefined;this.state=0}return t};t.prototype.itemIndexForTop=function(t){var r=this.cachedHeights;for(var e=0;e<r.length;e++){if(r[e]>t){return e}}return r.length-1};t.prototype.reorderMove=function(t,r){var e=this.selectedItemHeight;var i=this.el.children;for(var n=0;n<i.length;n++){var s=i[n].style;var o="";if(n>t&&n<=r){o="translateY(".concat(-e,"px)")}else if(n<t&&n>=r){o="translateY(".concat(e,"px)")}s["transform"]=o}};t.prototype.autoscroll=function(t){if(!this.scrollEl){return 0}var r=0;if(t<this.scrollElTop){r=-_}else if(t>this.scrollElBottom){r=_}if(r!==0){this.scrollEl.scrollBy(0,r)}return this.scrollEl.scrollTop-this.scrollElInitial};t.prototype.render=function(){var t;var r=c(this);return i(n,{class:(t={},t[r]=true,t["reorder-enabled"]=!this.disabled,t["reorder-list-active"]=this.state!==0,t)})};Object.defineProperty(t.prototype,"el",{get:function(){return s(this)},enumerable:false,configurable:true});Object.defineProperty(t,"watchers",{get:function(){return{disabled:["disabledChanged"]}},enumerable:false,configurable:true});return t}());var k=function(t){return t["$ionIndex"]};var x=function(t,r){var e;while(t){e=t.parentElement;if(e===r){return t}t=e}return undefined};var j=60;var _=10;var z="reorder-selected";var S=function(t,r,e){var i=t[r];t.splice(r,1);t.splice(e,0,i);return t.slice()};g.style=w}}}));