...
const index$2 = require('./index-174dc666.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-b19eb3c8.js'); }).then((module) => module.startStatusTap());
        }
