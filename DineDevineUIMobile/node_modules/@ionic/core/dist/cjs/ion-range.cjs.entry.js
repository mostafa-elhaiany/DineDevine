...
const Range = class {
  ...
  renderLegacyRange() {
    if (!this.hasLoggedDeprecationWarning) {
      index$1.printIonWarning(`ion-range now requires providing a label with either the label slot or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the component or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        index$1.printIonWarning(`ion-range is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
    ...
    return (index.h(index.Host, { onFocusin: this.onFocus, onFocusout: this.onBlur, id: rangeId, class: theme.createColorClasses(this.color, {
        ...
        'range-has-pin': pin,
        'legacy-range': true,
      }) }, index.h("slot", { name: "start" }), this.renderRangeSlider(), index.h("slot", { name: "end" })));
  }
  /**
  ...
  renderRange() {
    ...
    return (index.h(index.Host, { onFocusin: this.onFocus, onFocusout: this.onBlur, id: rangeId, class: theme.createColorClasses(this.color, {
      ...
      }) }, index.h("label", { class: "range-wrapper", id: "range-label" }, index.h("div", { class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !hasLabel,
      } }, label !== undefined ? index.h("div", { class: "label-text" }, label) : index.h("slot", { name: "label" })), index.h("div", { class: "native-wrapper" }, index.h("slot", { name: "start" }), this.renderRangeSlider(), index.h("slot", { name: "end" })))));
  }
  get hasLabel() {
  ...
  renderRangeSlider() {
    ...
    return (index.h("div", { class: "range-slider", ref: (rangeEl) => (this.rangeSlider = rangeEl) }, ticks.map((tick) => (index.h("div", { style: tickStyle(tick), role: "presentation", class: {
        'range-tick': true,
        'range-tick-active': tick.active,
      }, part: tick.active ? 'tick-active' : 'tick' }))), index.h("div", { class: "range-bar-container" }, index.h("div", { class: "range-bar", role: "presentation", part: "bar" }), index.h("div", { class: {
        'range-bar': true,
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = helpers.clamp(min, value, max);
