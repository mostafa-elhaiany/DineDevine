...
const Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign(Object.assign({}, helpers.inheritAriaAttributes(this.el)), helpers.inheritAttributes(this.el, ['tabindex', 'title', 'data-form-type']));
  }
  connectedCallback() {
    const { el } = this;
    this.legacyFormController = formController.createLegacyFormController(el);
    this.slotMutationController = input_utils.createSlotMutationController(el, 'label', () => index.forceUpdate(this));
  ...
  renderCounter() {
    ...
    return index.h("div", { class: "counter" }, input_utils.getCounterText(value, maxlength, counterFormatter));
  }
  /**
  ...
  renderLabelContainer() {
    ...
    if (hasOutlineFill) {
       ...
       */
      return [
        index.h("div", { class: "input-outline-container" }, index.h("div", { class: "input-outline-start" }), index.h("div", { class: {
            'input-outline-notch': true,
            'input-outline-notch-hidden': !this.hasLabel,
          } }, index.h("div", { class: "notch-spacer", "aria-hidden": "true", ref: (el) => (this.notchSpacerEl = el) }, this.label)), index.h("div", { class: "input-outline-end" })),
        this.renderLabel(),
      ];
    }
    /**
  ...
  renderInput() {
    ...
    return (index.h(index.Host, { class: theme.createColorClasses(this.color, {
         ...
         */
        ev.preventDefault();
      }, onClick: this.clearTextInput }, index.h("ion-icon", { "aria-hidden": "true", icon: mode === 'ios' ? index$1.closeCircle : index$1.closeSharp })))), shouldRenderHighlight && index.h("div", { class: "input-highlight" })), this.renderBottomContent()));
  }
  // TODO FW-2764 Remove this
  renderLegacyInput() {
    if (!this.hasLoggedDeprecationWarning) {
      index$2.printIonWarning(`ion-input now requires providing a label with either the "label" property or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the "label" property or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        index$2.printIonWarning(`ion-input is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new input syntax.`, this.el);
    ...
    return (index.h(index.Host, { "aria-disabled": this.disabled ? 'true' : null, class: theme.createColorClasses(this.color, {
         ...
         */
        ev.preventDefault();
      }, onClick: this.clearTextInput }, index.h("ion-icon", { "aria-hidden": "true", icon: mode === 'ios' ? index$1.closeCircle : index$1.closeSharp })))));
  }
  render() {
