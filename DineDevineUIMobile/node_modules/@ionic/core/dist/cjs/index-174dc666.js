...
const iosTransitionAnimation = () => Promise.resolve().then(function () { return require('./ios.transition-74ad019b.js'); });
const mdTransitionAnimation = () => Promise.resolve().then(function () { return require('./md.transition-efcc0ad3.js'); });
// TODO(FW-2832): types
 ...
 */
const waitForMount = () => {
  return new Promise((resolve) => helpers.raf(() => helpers.raf(() => resolve())));
};
const deepReady = async (el) => {
  ...
  if (element) {
    if (element.componentOnReady != null) {
       ...
       */
      const waitForCustomElement = new Promise((resolve) => helpers.raf(resolve));
...
exports.waitForMount = waitForMount;
