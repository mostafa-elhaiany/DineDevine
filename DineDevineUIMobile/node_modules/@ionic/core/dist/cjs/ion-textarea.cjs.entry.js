...
const Textarea = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign(Object.assign({}, helpers.inheritAriaAttributes(this.el)), helpers.inheritAttributes(this.el, ['data-form-type', 'title', 'tabindex']));
  }
  componentDidLoad() {
  ...
  renderLegacyTextarea() {
    if (!this.hasLoggedDeprecationWarning) {
      index$1.printIonWarning(`ion-textarea now requires providing a label with either the "label" property or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the "label" property or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
  ...
  renderLabelContainer() {
    ...
    if (hasOutlineFill) {
       ...
       */
      return [
        index.h("div", { class: "textarea-outline-container" }, index.h("div", { class: "textarea-outline-start" }), index.h("div", { class: {
            'textarea-outline-notch': true,
            'textarea-outline-notch-hidden': !this.hasLabel,
          } }, index.h("div", { class: "notch-spacer", "aria-hidden": "true", ref: (el) => (this.notchSpacerEl = el) }, this.label)), index.h("div", { class: "textarea-outline-end" })),
        this.renderLabel(),
      ];
    }
    /**
  ...
  renderBottomContent() {
    ...
    return (index.h("div", { class: "textarea-bottom" }, this.renderHintText(), this.renderCounter()));
  }
  renderTextarea() {
    ...
    return (index.h(index.Host, { class: theme.createColorClasses(this.color, {
      ...
      }) }, index.h("label", { class: "textarea-wrapper" }, this.renderLabelContainer(), index.h("div", { class: "native-wrapper", ref: (el) => (this.textareaWrapper = el) }, index.h("textarea", Object.assign({ class: "native-textarea", ref: (el) => (this.nativeInput = el), id: inputId, disabled: disabled, autoCapitalize: this.autocapitalize, autoFocus: this.autofocus, enterKeyHint: this.enterkeyhint, inputMode: this.inputmode, minLength: this.minlength, maxLength: this.maxlength, name: this.name, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellcheck: this.spellcheck, cols: this.cols, rows: this.rows, wrap: this.wrap, onInput: this.onInput, onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown }, this.inheritedAttributes), value)), shouldRenderHighlight && index.h("div", { class: "textarea-highlight" })), this.renderBottomContent()));
  }
  render() {
