/*!
 Stencil Node System v4.6.0 | MIT Licensed | https://stenciljs.com
 */
...
lockfile = createCommonjsModule((function(e) {
 e.exports = function(e) {
  ...
  class _ {
   ...
   getLockfile(e) {
    ...
    for (t = Object.keys(e).sort((p || function f() {
     ...
     E(p, "Package is missing a reference"), E(h, "Package is missing a remote");
  ...
  var n = r(11), i = r(23), s = r(48), o = r(31), a = r(49), l = "prototype", c = function(e, t, r) {
   var u, f, h, p = e & c.F, d = e & c.G, m = e & c.S, g = e & c.P, y = e & c.B, E = e & c.W, v = d ? i : i[t] || (i[t] = {}), b = v[l], _ = d ? n : m ? n[t] : (n[t] || {})[l];
   for (u in d && (r = t), r) (f = !p && _ && void 0 !== _[u]) && a(v, u) || (h = f ? _[u] : r[u], 
   v[u] = d && "function" != typeof _[u] ? r[u] : y && f ? s(h, n) : E && _[u] == h ? function(e) {
    ...
    return t[l] = e[l], t;
   }(h) : g && "function" == typeof h ? s(Function.call, h) : h, g && ((v.virtual || (v.virtual = {}))[u] = h, 
   e & c.R && b && !b[u] && o(b, u, h)));
  };
  ...
  function a(e, t) {
   return A.indexOf(e.toLowerCase()) >= A.indexOf(t.toLowerCase()) ? e : t;
  }
  ...
  e.exports.parse = n, e.exports.stringify = s, e.exports.fromHex = function E(e, t, r) {
  ...
  const O = new Set(c.getHashes()), A = [ "md5", "whirlpool", "sha1", "sha224", "sha256", "sha384", "sha512", "sha3", "sha3-256", "sha3-384", "sha3-512", "sha3_256", "sha3_384", "sha3_512" ].filter((e => O.has(e)));
 }, , , , , function(e, t, r) {
  function n(e, t) {
   e = e || {}, t = t || {};
   var r = {};
  ...
  l = i.GLOBSTAR = s.GLOBSTAR = {}, c = r(175), u = {
  ...
  }, s.prototype.debug = function() {}, s.prototype.make = function E() {
   var e, t, r;
  ...
  }, s.prototype.parseNegate = function v() {
   ...
   if ("" === e) return "";
   for (i = "", s = !!n.nocase, o = !1, a = [], c = [], g = !1, y = -1, E = -1, v = "." === e.charAt(0) ? "" : n.dot ? "(?!(?:^|\\/)\\.{1,2}(?:$|\\/))" : "(?!\\.)", 
   ...
   case "!":
    if (this.debug("%s\t%s %s %j <-- stateChar", e, _, i, S), g) {
     this.debug("  in class"), "!" === S && _ === E + 1 && (S = "^"), i += S;
     continue;
    }
   ...
   case ")":
    ...
    r(), s = !0, O = a.pop(), i += O.close, "!" === O.type && c.push(O), O.reEnd = i.length;
    continue;
   ...
   case "]":
    ...
    if (g) {
     ...
     try {
      ...
      k = this.parse(A, m), i = i.substr(0, y) + "\\[" + k[0] + "\\]", s = s || k[1], 
      g = !1;
      continue;
     }
    }
   ...
   for (g && (A = e.substr(E + 1), k = this.parse(A, m), i = i.substr(0, y) + "\\[" + k[0], 
   s = s || k[1]), O = a.pop(); O; O = a.pop()) L = i.slice(O.reStart + O.open.length), 
   this.debug("setting tail", i, O), L = L.replace(/((?:\\{2}){0,64})(\\?)\|/g, (function(e, t, r) {
    return r || (r = "\\"), t + t + r + "|";
   })), this.debug("tail=%j\n   %s", L, L, O, i), C = "*" === O.type ? h : "?" === O.type ? f : "\\" + O.type, 
   s = !0, i = i.slice(0, O.reStart) + C + "\\(" + L;
   ...
   for ($ = c.length - 1; $ > -1; $--) {
    for (R = c[$], x = i.slice(0, R.reStart), N = i.slice(R.reStart, R.reEnd - 8), I = i.slice(R.reEnd - 8, R.reEnd), 
    I += P = i.slice(R.reEnd), j = x.split("(").length - 1, D = P, _ = 0; _ < j; _++) D = D.replace(/\)[+*?]?/, "");
  ...
  _ = n.GlobSync = p.GlobSync, n.glob = n, n.hasMagic = function(e, t) {
   ...
   this.paused) this._processQueue.push([ e, t, r, n ]); else {
    ...
    c = o) : c = o, u = this._makeAbs(c), E(this, c)) return n();
  ...
  Object.defineProperty(t, "__esModule", {
   ...
   return function i(e) {
    return e.includes(C) && e.includes(L) && e.includes(k);
   }(e = (0, (c || function n() {
    return c = s(r(122));
  ...
  const p = /^yarn lockfile v(\d+)$/, d = "BOOLEAN", m = "STRING", g = "COLON", y = "NEWLINE", E = "COMMENT", v = "INDENT", b = "INVALID", _ = "NUMBER", w = "COMMA", S = [ d, m, _ ];
  class O {
    ...
    this.comments = [], this.tokens = function* r(e) {
     ...
     for (;e.length; ) {
      ...
      if ("\n" === e[0] || "\r" === e[0]) s++, "\n" === e[1] && s++, n++, i = 0, yield t(y); else if ("#" === e[0]) {
       ...
       s = r.length, yield t(v, r.length / 2);
      } else s++; else if ('"' === e[0]) {
       let r = "";
       for (let t = 0; ;t++) {
        const n = e[t];
    ...
    for (;;) {
     ...
     if (h.type === y) {
      ...
      if (h.type === m) {
       ...
       } else if (E = a, S.indexOf(E.type) >= 0) {
  ...
  e.exports = function(e, t, r, g, y, E, v) {
   ...
   L = y ? w ? b("entries") : k : void 0, (C = "Array" == t && O.entries || A) && (R = u(C.call(new e))) !== Object.prototype && R.next && (c(R, _, !0), 
   n || "function" == typeof R[f] || o(R, f, m)), w && A && A.name !== d && (S = !0, 
   k = function e() {
    return A.call(this);
  ...
  var n, i, s, o = r(48), a = r(185), l = r(102), c = r(68), u = r(11), f = u.process, h = u.setImmediate, p = u.clearImmediate, d = u.MessageChannel, m = u.Dispatch, g = 0, y = {}, E = "onreadystatechange", v = function() {
   var e, t = +this;
  ...
  h && p || (h = function e(t) {
   ...
   u.postMessage(e + "", "*");
  }, u.addEventListener("message", b, !1)) : n = E in c("script") ? function(e) {
   l.appendChild(c("script"))[E] = function() {
  ...
  let p, d = (u = (0, (a || n()).default)((function*(e, t, r) {
   ...
   if (!p) {
    if (n) try {
     i = yield E(t, "a", r.mode);
    } catch (e) {
     try {
      i = yield E(t, "r", r.mode);
     } catch (e) {
      return;
     }
    }
  ...
  (c || s()).promisify)((l || i()).default.lstat), E = (0, (c || s()).promisify)((l || i()).default.open), v = (0, 
  ...
  function u(e, t) {
   ...
   if (E = I.pre, m = I.post.length ? u(I.post, !1) : [ "" ], f) for (b = n(d[0]), 
   _ = n(d[1]), w = Math.max(d[0].length, d[1].length), S = 3 == d.length ? Math.abs(n(d[2])) : 1, 
   O = l, _ < b && (S *= -1, O = c), A = d.some(a), v = [], k = b; O(k, _); k += S) i ? "\\" === (L = String.fromCharCode(k)) && (L = "") : (L = String(k), 
   A && (C = w - L.length) > 0 && (T = new Array(C + 1).join("0"), L = k < 0 ? "-" + T + L.slice(1) : T + L)), 
   v.push(L); else v = g(d, (function(e) {
    return u(e, !1);
   }));
   for ($ = 0; $ < v.length; $++) for (R = 0; R < m.length; R++) x = E + v[$] + m[R], 
   (!t || f || x) && N.push(x);
   return N;
  }
  ...
  t = e.exports = function(e, t, r, f, h) {
   var p, d, m, g, y = h ? function() {
    return e;
   } : l(e), E = n(r, f, t ? 2 : 1), v = 0;
   if ("function" != typeof y) throw TypeError(e + " is not iterable!");
   if (s(y)) {
    for (p = a(e.length); p > v; v++) if ((g = t ? E(o(d = e[v])[0], d[1]) : E(e[v])) === c || g === u) return g;
   } else for (m = y.call(e); !(d = m.next()).done; ) if ((g = i(m, E, d.value, t)) === c || g === u) return g;
  ...
  var n, i, s, o, a = r(69), l = r(11), c = r(48), u = r(100), f = r(41), h = r(34), p = r(46), d = r(181), m = r(183), g = r(108), y = r(109).set, E = r(191)(), v = r(70), b = r(104), _ = r(202), w = r(105), S = "Promise", O = l.TypeError, A = l.process, k = A && A.versions, L = k && k.v8 || "", C = l[S], T = "process" == u(A), $ = function() {}, R = i = v.f, x = !!function() {
   var e, t;
   try {
    ...
    E((function() {
     for (var n = e._v, i = 1 == e._s, s = 0, o = function(t) {
      ...
      try {
       ...
       u && (u.exit(), o = !0)), r === t.promise ? c(O("Promise-chain cycle")) : (s = N(r)) ? s.call(r, l, c) : l(r)) : c(n);
      } catch (e) {
       u && !o && u.exit(), c(e);
      }
     }; r.length > s; ) o(r[s++]);
   ...
   y.call(l, (function() {
    ...
    if (s && (t = b((function() {
     T ? A.emit("unhandledRejection", i, e) : (r = l.onunhandledrejection) ? r({
      promise: e,
      reason: i
   ...
   y.call(l, (function() {
    var t;
    T ? A.emit("rejectionHandled", e) : (t = l.onrejectionhandled) && t({
     promise: e,
     reason: e._v
    });
   }));
  ...
  x || (C = function e(t) {
   ...
   all: function e(t) {
    var r = this, n = R(r), i = n.resolve, s = n.reject, o = b((function() {
     var e = [], n = 0, o = 1;
     m(t, !1, (function(t) {
      var a = n++, l = !1;
   ...
   race: function e(t) {
    var r = this, n = R(r), i = n.reject, s = b((function() {
     m(t, !1, (function(e) {
  ...
  t.realpathSync = function e(t, r) {
   ...
   m = p, p += g[0], d = m + g[1], h = n.lastIndex, !(f[d] || r && r[d] === d)) {
    if (r && Object.prototype.hasOwnProperty.call(r, d)) y = r[d]; else {
     if (!(E = a.lstatSync(d)).isSymbolicLink()) {
      f[d] = !0, r && (r[d] = d);
      continue;
     }
     v = null, o || (b = E.dev.toString(32) + ":" + E.ino.toString(32), u.hasOwnProperty(b) && (v = u[b])), 
     null === v && (a.statSync(d), v = a.readlinkSync(d)), y = s.resolve(m, v), r && (r[d] = y), 
     o || (u[b] = v);
    }
   ...
   function u() {
    var e = i.exec(t);
    E = e[0].length, v = e[0], b = e[0], _ = "", o && !y[b] ? a.lstat(b, (function(e) {
     if (e) return c(e);
     y[b] = !0, f();
    })) : process.nextTick(f);
   }
   function f() {
    if (E >= t.length) return r && (r[m] = t), c(null, t);
    n.lastIndex = E;
    var e = n.exec(t);
    return _ = v, v += e[0], b = _ + e[1], E = n.lastIndex, y[b] || r && r[b] === b ? process.nextTick(f) : r && Object.prototype.hasOwnProperty.call(r, b) ? d(r[b]) : a.lstat(b, h);
   }
   function h(e, t) {
    if (e) return c(e);
  ...
  var n = r(123), i = Object.create(null), s = r(61);
  e.exports = n((function o(e, t) {
   return i[e] ? (i[e].push(t), null) : (i[e] = [ t ], function r(e) {
    return s((function t() {
     var r, n = i[e], s = n.length, o = function a(e) {
  ...
  function s(e, t, r) {
   f(e), f(t), f("function" == typeof r), t.lstat(e, (function(n, i) {
    return n && "ENOENT" === n.code ? r(null) : (n && "EPERM" === n.code && E && o(e, t, n, r), 
    i && i.isDirectory() ? l(e, t, n, r) : void t.unlink(e, (function(n) {
     if (n) {
      if ("ENOENT" === n.code) return r(null);
      if ("EPERM" === n.code) return E ? o(e, t, n, r) : l(e, t, n, r);
  ...
  function c(e, t) {
   ...
   if (r.length) for (i = 0; i < r.length; i++) {
    ...
    try {
     ...
     "EPERM" === r.code && E && a(e, t, r);
    }
    try {
     s && s.isDirectory() ? u(e, t, null) : t.unlinkSync(e);
    } catch (r) {
     if ("ENOENT" === r.code) return;
     if ("EPERM" === r.code) return E ? a(e, t, r) : u(e, t, r);
...
constants = {
 ...
 const {MAX_SAFE_COMPONENT_LENGTH: r, MAX_SAFE_BUILD_LENGTH: n, MAX_LENGTH: i} = constants, s = (t = e.exports = {}).re = [], o = t.safeRe = [], a = t.src = [], l = t.t = {};
 let c = 0;
 const u = "[a-zA-Z0-9-]", f = [ [ "\\s", 1 ], [ "\\d", i ], [ u, n ] ], h = (e, t, r) => {
  const n = (e => {
   for (const [t, r] of f) e = e.split(`${t}*`).join(`${t}{0,${r}}`).split(`${t}+`).join(`${t}{1,${r}}`);
   return e;
  })(t), i = c++;
  debug_1(e, i, t), l[e] = i, a[i] = t, s[i] = new RegExp(t, r ? "g" : void 0), o[i] = new RegExp(n, r ? "g" : void 0);
 };
 h("NUMERICIDENTIFIER", "0|[1-9]\\d*"), h("NUMERICIDENTIFIERLOOSE", "\\d+"), h("NONNUMERICIDENTIFIER", `\\d*[a-zA-Z-]${u}*`), 
 h("MAINVERSION", `(${a[l.NUMERICIDENTIFIER]})\\.(${a[l.NUMERICIDENTIFIER]})\\.(${a[l.NUMERICIDENTIFIER]})`), 
 h("MAINVERSIONLOOSE", `(${a[l.NUMERICIDENTIFIERLOOSE]})\\.(${a[l.NUMERICIDENTIFIERLOOSE]})\\.(${a[l.NUMERICIDENTIFIERLOOSE]})`), 
 h("PRERELEASEIDENTIFIER", `(?:${a[l.NUMERICIDENTIFIER]}|${a[l.NONNUMERICIDENTIFIER]})`), 
 h("PRERELEASEIDENTIFIERLOOSE", `(?:${a[l.NUMERICIDENTIFIERLOOSE]}|${a[l.NONNUMERICIDENTIFIER]})`), 
 h("PRERELEASE", `(?:-(${a[l.PRERELEASEIDENTIFIER]}(?:\\.${a[l.PRERELEASEIDENTIFIER]})*))`), 
 h("PRERELEASELOOSE", `(?:-?(${a[l.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${a[l.PRERELEASEIDENTIFIERLOOSE]})*))`), 
 h("BUILDIDENTIFIER", `${u}+`), h("BUILD", `(?:\\+(${a[l.BUILDIDENTIFIER]}(?:\\.${a[l.BUILDIDENTIFIER]})*))`), 
 h("FULLPLAIN", `v?${a[l.MAINVERSION]}${a[l.PRERELEASE]}?${a[l.BUILD]}?`), h("FULL", `^${a[l.FULLPLAIN]}$`), 
 h("LOOSEPLAIN", `[v=\\s]*${a[l.MAINVERSIONLOOSE]}${a[l.PRERELEASELOOSE]}?${a[l.BUILD]}?`), 
 h("LOOSE", `^${a[l.LOOSEPLAIN]}$`), h("GTLT", "((?:<|>)?=?)"), h("XRANGEIDENTIFIERLOOSE", `${a[l.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`), 
 h("XRANGEIDENTIFIER", `${a[l.NUMERICIDENTIFIER]}|x|X|\\*`), h("XRANGEPLAIN", `[v=\\s]*(${a[l.XRANGEIDENTIFIER]})(?:\\.(${a[l.XRANGEIDENTIFIER]})(?:\\.(${a[l.XRANGEIDENTIFIER]})(?:${a[l.PRERELEASE]})?${a[l.BUILD]}?)?)?`), 
 h("XRANGEPLAINLOOSE", `[v=\\s]*(${a[l.XRANGEIDENTIFIERLOOSE]})(?:\\.(${a[l.XRANGEIDENTIFIERLOOSE]})(?:\\.(${a[l.XRANGEIDENTIFIERLOOSE]})(?:${a[l.PRERELEASELOOSE]})?${a[l.BUILD]}?)?)?`), 
 h("XRANGE", `^${a[l.GTLT]}\\s*${a[l.XRANGEPLAIN]}$`), h("XRANGELOOSE", `^${a[l.GTLT]}\\s*${a[l.XRANGEPLAINLOOSE]}$`), 
 h("COERCE", `(^|[^\\d])(\\d{1,${r}})(?:\\.(\\d{1,${r}}))?(?:\\.(\\d{1,${r}}))?(?:$|[^\\d])`), 
 h("COERCERTL", a[l.COERCE], !0), h("LONETILDE", "(?:~>?)"), h("TILDETRIM", `(\\s*)${a[l.LONETILDE]}\\s+`, !0), 
 t.tildeTrimReplace = "$1~", h("TILDE", `^${a[l.LONETILDE]}${a[l.XRANGEPLAIN]}$`), 
 h("TILDELOOSE", `^${a[l.LONETILDE]}${a[l.XRANGEPLAINLOOSE]}$`), h("LONECARET", "(?:\\^)"), 
 h("CARETTRIM", `(\\s*)${a[l.LONECARET]}\\s+`, !0), t.caretTrimReplace = "$1^", h("CARET", `^${a[l.LONECARET]}${a[l.XRANGEPLAIN]}$`), 
 h("CARETLOOSE", `^${a[l.LONECARET]}${a[l.XRANGEPLAINLOOSE]}$`), h("COMPARATORLOOSE", `^${a[l.GTLT]}\\s*(${a[l.LOOSEPLAIN]})$|^$`), 
 h("COMPARATOR", `^${a[l.GTLT]}\\s*(${a[l.FULLPLAIN]})$|^$`), h("COMPARATORTRIM", `(\\s*)${a[l.GTLT]}\\s*(${a[l.LOOSEPLAIN]}|${a[l.XRANGEPLAIN]})`, !0), 
 t.comparatorTrimReplace = "$1$2$3", h("HYPHENRANGE", `^\\s*(${a[l.XRANGEPLAIN]})\\s+-\\s+(${a[l.XRANGEPLAIN]})\\s*$`), 
 h("HYPHENRANGELOOSE", `^\\s*(${a[l.XRANGEPLAINLOOSE]})\\s+-\\s+(${a[l.XRANGEPLAINLOOSE]})\\s*$`), 
 h("STAR", "(<|>)?=?\\s*\\*"), h("GTE0", "^\\s*>=\\s*0\\.0\\.0\\s*$"), h("GTE0PRE", "^\\s*>=\\s*0\\.0\\.0-0\\s*$");
}));
...
exports.createNodeLogger = () => {
 ...
 var t;
 const r = null !== (t = null == e ? void 0 : e.process) && void 0 !== t ? t : global.process, n = null == e ? void 0 : e.logger, i = new Set, s = [], o = require$$6.cpus(), a = o.length, l = require$$6.platform(), c = path__default.default.join(__dirname, "..", "..", "compiler", "stencil.js"), u = path__default.default.join(__dirname, "..", "..", "dev-server", "index.js"), f = () => {
  const e = [];
  let t;
  ...
  {
   stencilPath: h.getCompilerExecutingPath(),
   diagnostics: []
  }),
  ...
  removeDir: (e, t) => new Promise((r => {
   t && t.recursive ? fs__default.default.rm(e, {
    recursive: !0,
    force: !0
   }, (t => {
    r({
  ...
  removeDirSync(e, t) {
   try {
    return t && t.recursive ? fs__default.default.rmSync(e, {
     recursive: !0,
     force: !0
  ...
  setupCompiler(e) {
   ...
   h.watchTimeout = 80, h.events = (() => {
    ...
    return h.addDestroy(o), {
     close() {
      h.removeDestroy(o), s.close();
     }
    };
   }, h.watchFile = (e, r) => {
