/*!
 Stencil Testing v4.6.0 | MIT Licensed | https://stenciljs.com
 */
...
}, testingDir = __dirname, rootDir = path$2.join(testingDir, ".."), internalDir = path$2.join(rootDir, "internal"), moduleExtensions = [ "ts", "tsx", "js", "mjs", "jsx" ], moduleExtensionRegexp = "(" + moduleExtensions.join("|") + ")", preset = {
 moduleFileExtensions: [ ...moduleExtensions, "json", "d.ts" ],
 moduleNameMapper: {
  "^@stencil/core/cli$": path$2.join(rootDir, "cli", "index.js"),
  "^@stencil/core/compiler$": path$2.join(rootDir, "compiler", "stencil.js"),
  "^@stencil/core/internal$": path$2.join(internalDir, "testing", "index.js"),
  "^@stencil/core/internal/app-data$": path$2.join(internalDir, "app-data", "index.cjs"),
  "^@stencil/core/internal/app-globals$": path$2.join(internalDir, "app-globals", "index.js"),
  "^@stencil/core/internal/testing$": path$2.join(internalDir, "testing", "index.js"),
  "^@stencil/core/mock-doc$": path$2.join(rootDir, "mock-doc", "index.cjs"),
  "^@stencil/core/sys$": path$2.join(rootDir, "sys", "node", "index.js"),
  "^@stencil/core/testing$": path$2.join(testingDir, "index.js"),
  "^@stencil/core$": path$2.join(internalDir, "testing", "index.js")
 },
 setupFilesAfterEnv: [ path$2.join(testingDir, "jest-setuptestframework.js") ],
 testEnvironment: path$2.join(testingDir, "jest-environment.js"),
 testPathIgnorePatterns: [ "/.cache", "/.stencil", "/.vscode", "/dist", "/node_modules", "/www" ],
 testRegex: "(/__tests__/.*|\\.?(test|spec))\\." + moduleExtensionRegexp + "$",
 transform: {
  "^.+\\.(ts|tsx|jsx|css|mjs)$": path$2.join(testingDir, "jest-preprocessor.js")
 },
...
const getJestFacade = () => (JEST_STENCIL_FACADE || (major_1(jest$1.getVersion()), 
JEST_STENCIL_FACADE = new Jest27Stencil), JEST_STENCIL_FACADE), createConfigFlags = (e = {}) => ({
 task: null,
 args: [],
 knownArgs: [],
 unknownArgs: [],
