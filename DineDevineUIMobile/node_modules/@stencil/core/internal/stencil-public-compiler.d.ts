 ...
 */
type StrictConfigFields = keyof Pick<Config, 'cacheDir' | 'devServer' | 'extras' | 'flags' | 'fsNamespace' | 'hydratedFlag' | 'logger' | 'logLevel' | 'namespace' | 'outputTargets' | 'packageJsonFilePath' | 'rollupConfig' | 'rootDir' | 'srcDir' | 'srcIndexHtml' | 'sys' | 'testing' | 'transformAliasedImportPaths' | 'validatePrimaryPackageOutputTarget'>;
/**
