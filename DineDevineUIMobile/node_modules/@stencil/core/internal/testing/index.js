...
const mockDoc = require("@stencil/core/mock-doc"), appData = require("@stencil/core/internal/app-data");
...
const createElm = (e, t, a, o) => {
 ...
 appData.BUILD.updatable && null !== o && null !== s ? ((e, t, a, o) => {
  let s, n, l = 0, r = 0, p = 0, i = 0, d = t.length - 1, c = t[0], $ = t[d], u = o.length - 1, h = o[0], m = o[u];
  for (;l <= d && r <= u; ) if (null == c) c = t[++l]; else if (null == $) $ = t[--d]; else if (null == h) h = o[++r]; else if (null == m) m = o[--u]; else if (isSameVnode(c, h)) patch(c, h), 
  c = t[++l], h = o[++r]; else if (isSameVnode($, m)) patch($, m), $ = t[--d], m = o[--u]; else if (isSameVnode(c, m)) !appData.BUILD.slotRelocation || "slot" !== c.$tag$ && "slot" !== m.$tag$ || putBackInOriginalLocation(c.$elm$.parentNode, !1), 
  patch(c, m), e.insertBefore(c.$elm$, $.$elm$.nextSibling), c = t[++l], m = o[--u]; else if (isSameVnode($, h)) !appData.BUILD.slotRelocation || "slot" !== c.$tag$ && "slot" !== m.$tag$ || putBackInOriginalLocation($.$elm$.parentNode, !1), 
  patch($, h), e.insertBefore($.$elm$, c.$elm$), $ = t[--d], h = o[++r]; else {
   if (p = -1, appData.BUILD.vdomKey) for (i = l; i <= d; ++i) if (t[i] && null !== t[i].$key$ && t[i].$key$ === h.$key$) {
    p = i;
    break;
   }
   appData.BUILD.vdomKey && p >= 0 ? (n = t[p], n.$tag$ !== h.$tag$ ? s = createElm(t && t[r], a, p, e) : (patch(n, h), 
   t[p] = void 0, s = n.$elm$), h = o[++r]) : (s = createElm(t && t[r], a, r, e), h = o[++r]), 
 ...
 for (const e of t) if (1 === e.nodeType) {
  if (e["s-sr"]) {
   const a = e["s-sn"];
   e.hidden = !1;
   for (const o of t) if (o["s-hn"] !== e["s-hn"] || "" !== a) {
    if (1 === o.nodeType && a === o.getAttribute("slot")) {
     e.hidden = !0;
     break;
    }
   } else if (1 === o.nodeType || 3 === o.nodeType && "" !== o.textContent.trim()) {
    e.hidden = !0;
    break;
   }
  }
 ...
 for (const s of e.childNodes) {
  if (s["s-sr"] && (t = s["s-cr"]) && t.parentNode) {
   ...
   const e = s["s-sn"];
   for (o = a.length - 1; o >= 0; o--) if (t = a[o], !t["s-cn"] && !t["s-nr"] && t["s-hn"] !== s["s-hn"]) if (isNodeLocatedInSlot(t, e)) {
    let a = relocateNodes.find((e => e.$nodeToRelocate$ === t));
    checkSlotFallbackVisibility = !0, t["s-sn"] = t["s-sn"] || e, a ? a.$slotRefNode$ = s : relocateNodes.push({
     $slotRefNode$: s,
     $nodeToRelocate$: t
    }), t["s-sr"] && relocateNodes.map((e => {
     isNodeLocatedInSlot(e.$nodeToRelocate$, t["s-sn"]) && (a = relocateNodes.find((e => e.$nodeToRelocate$ === t)), 
 ...
 patch(n, l), appData.BUILD.slotRelocation) {
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   let e, t, a, o, s, n;
   markSlotContentForRelocation(l.$elm$);
   let r = 0;
 ...
 e.$queuedListeners$ = void 0)), emitLifecycleEvent(a, "componentWillLoad"), appData.BUILD.cmpWillLoad && (n = safeCall(s, "componentWillLoad"))) : (emitLifecycleEvent(a, "componentWillUpdate"), 
...
}, enqueue = (e, t) => isPromisey(e) ? e.then(t) : t(), isPromisey = e => e instanceof Promise || e && e.then && "function" == typeof e.then, updateComponent = async (e, t, a) => {
 var o;
 ...
 if (appData.BUILD.asyncLoading && l && (l.map((e => e())), s["s-rc"] = void 0), 
 r(), n(), appData.BUILD.asyncLoading) {
  const t = null !== (o = s["s-p"]) && void 0 !== o ? o : [], a = () => postUpdateComponent(e);
...
const callRender = (e, t, a, o) => {
 ...
 appData.BUILD.method && appData.BUILD.lazyLoad && e.$onInstanceResolve$(a), appData.BUILD.asyncLoading && (e.$onRenderResolve$ && (e.$onRenderResolve$(), 
 ...
 if (appData.BUILD.member && t.$members$) {
  ...
  const s = Object.entries(t.$members$), n = e.prototype;
  if (s.map((([e, [o]]) => {
   (appData.BUILD.prop || appData.BUILD.state) && (31 & o || (!appData.BUILD.lazyLoad || 2 & a) && 32 & o) ? Object.defineProperty(n, e, {
    get() {
    ...
    configurable: !0,
    enumerable: !0
   }) : appData.BUILD.lazyLoad && appData.BUILD.method && 1 & a && 64 & o && Object.defineProperty(n, e, {
    value(...t) {
   ...
   const a = new Map;
   n.attributeChangedCallback = function(e, o, s) {
    plt.jmp((() => {
     const l = a.get(e);
     if (this.hasOwnProperty(l)) s = this[l], delete this[l]; else {
      if (n.hasOwnProperty(l) && "number" == typeof this[l] && this[l] == s) return;
      if (null == l) {
       const a = getHostRef(this), n = null == a ? void 0 : a.$flags$;
       if (!(8 & n) && 128 & n && s !== o) {
        const n = appData.BUILD.lazyLoad ? a.$hostElement$ : this, l = appData.BUILD.lazyLoad ? a.$lazyInstance$ : n, r = t.$watchers$[e];
        null == r || r.forEach((t => {
         null != l[t] && l[t].call(l, s, o, e);
        }));
       }
       return;
      }
     }
     this[l] = (null !== s || "boolean" != typeof this[l]) && s;
    }));
   }, e.observedAttributes = Array.from(new Set([ ...Object.keys(null !== (o = t.$watchers$) && void 0 !== o ? o : {}), ...s.filter((([e, t]) => 15 & t[0])).map((([e, o]) => {
    const s = o[1] || e;
 ...
 if (0 == (1 & plt.$flags$)) {
  ...
  1 & t.$flags$) addHostEventListeners(e, t, a.$listeners$, !1), (null == t ? void 0 : t.$lazyInstance$) ? fireConnectedCallback(t.$lazyInstance$) : (null == t ? void 0 : t.$onReadyPromise$) && t.$onReadyPromise$.then((() => fireConnectedCallback(t.$lazyInstance$))); else {
   let o;
 ...
 appData.BUILD.lazyLoad && appData.BUILD.disconnectedCallback && safeCall(e, "disconnectedCallback"), 
 ...
 if (0 == (1 & plt.$flags$)) {
  ...
  t.$rmListeners$ = void 0), appData.BUILD.lazyLoad ? (null == t ? void 0 : t.$lazyInstance$) ? disconnectInstance(t.$lazyInstance$) : (null == t ? void 0 : t.$onReadyPromise$) && t.$onReadyPromise$.then((() => disconnectInstance(t.$lazyInstance$))) : disconnectInstance(e);
 }
 ...
 e.prepend = function(...e) {
  e.forEach((e => {
   ...
   const a = e["s-sn"] = getSlotName(e), o = getHostSlotNode(this.childNodes, a);
   if (o) {
 ...
 e.insertAdjacentHTML = function(e, a) {
  ...
  let s;
  if (o.innerHTML = a, "afterbegin" === e) for (;s = o.firstChild; ) this.prepend(s); else if ("beforeend" === e) for (;s = o.firstChild; ) this.append(s);
 };
 ...
 e.insertAdjacentElement = function(e, a) {
  return "afterbegin" !== e && "beforeend" !== e ? t.call(this, e, a) : "afterbegin" === e ? (this.prepend(a), 
  a) : "beforeend" === e ? (this.append(a), a) : a;
 };
 ...
 appData.BUILD.patchPseudoShadowDom && appData.BUILD.scoped ? patchPseudoShadowDom(e.prototype, a) : (appData.BUILD.slotChildNodesFix && patchChildSlotNodes(e.prototype, a), 
 appData.BUILD.cloneNodeFix && patchCloneNode(e.prototype), appData.BUILD.appendChildSlotFix && patchSlotAppendChild(e.prototype), 
 appData.BUILD.scopedSlotTextContentFix && patchTextContent(e.prototype, a));
...
exports.addHostEventListeners = addHostEventListeners, exports.bootstrapLazy = (e, t = {}) => {
 ...
 appData.BUILD.hydrateClientSide && appData.BUILD.shadowDom) for (;h < c.length; h++) registerStyle(c[h].getAttribute("sty-id"), c[h].innerHTML.replace(/\/\*!@([^\/]+)\*\/[^\{]+\{/g, "$1{"));
 if (e.map((e => {
  e[1].map((a => {
   var o;
   const r = {
   ...
   appData.BUILD.member && (r.$members$ = a[2]), appData.BUILD.hostListener && (r.$listeners$ = a[3]), 
   appData.BUILD.reflect && (r.$attrsToReflect$ = []), appData.BUILD.watchCallback && (r.$watchers$ = null !== (o = a[4]) && void 0 !== o ? o : {}), 
   appData.BUILD.shadowDom && !exports.supportsShadow && 1 & r.$flags$ && (r.$flags$ |= 8);
   const p = appData.BUILD.transformTagName && t.transformTagName ? t.transformTagName(r.$tagName$) : r.$tagName$, i = class extends HTMLElement {
    constructor(e) {
     super(e), registerHost(e = this, r), appData.BUILD.shadowDom && 1 & r.$flags$ && (exports.supportsShadow ? appData.BUILD.shadowDelegatesFocus ? e.attachShadow({
      mode: "open",
   ...
   appData.BUILD.patchPseudoShadowDom && appData.BUILD.scoped ? patchPseudoShadowDom(i.prototype, r) : (appData.BUILD.slotChildNodesFix && patchChildSlotNodes(i.prototype, r), 
   appData.BUILD.cloneNodeFix && patchCloneNode(i.prototype), appData.BUILD.appendChildSlotFix && patchSlotAppendChild(i.prototype), 
   appData.BUILD.scopedSlotTextContentFix && patchTextContent(i.prototype, r)), appData.BUILD.formAssociated && 64 & r.$flags$ && (i.formAssociated = !0), 
   appData.BUILD.hotModuleReplacement && (i.prototype["s-hmr"] = function(e) {
    ((e, t, a) => {
     const o = getHostRef(e);
     o.$flags$ = 1, initializeComponent(e, o, t);
    })(this, r);
   }), r.$lazyBundleId$ = e[0], n.includes(p) || l.get(p) || (s.push(p), l.define(p, proxyComponent(i, r, 1)));
  }));
...
}, exports.forceUpdate = forceUpdate, exports.getAssetPath = e => {
 const t = new URL(e, plt.$resourcesUrl$);
 return t.origin !== win.location.origin ? t.href : t.pathname;
}, exports.getElement = getElement, exports.getHostRef = getHostRef, exports.getMode = e => getHostRef(e).$modeName$, 
...
exports.readTask = function readTask(e) {
 ...
 plt.$flags$ = 0, Object.assign(plt, e), null != plt.$orgLocNodes$ && (plt.$orgLocNodes$.clear(), 
