...
const createElm = (e, t, o, n) => {
 ...
 if (hostTagName = n.tagName, BUILD.isDev && Array.isArray(t) && t.some(isHost)) throw new Error(`The <Host> must be the single root component.\nLooks like the render() function of "${hostTagName.toLowerCase()}" is returning an array that contains the <Host>.\n\nThe render() function should look like this instead:\n\nrender() {\n  // Do not return an array\n  return (\n    <Host>{content}</Host>\n  );\n}\n  `);
 if (BUILD.reflect && s.$attrsToReflect$ && (a.$attrs$ = a.$attrs$ || {}, s.$attrsToReflect$.map((([e, t]) => a.$attrs$[t] = n[e]))), 
 o && a.$attrs$) for (const e of Object.keys(a.$attrs$)) n.hasAttribute(e) && ![ "key", "ref", "style", "class" ].includes(e) && (a.$attrs$[e] = n[e]);
 if (a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = l.$elm$ = BUILD.shadowDom && n.shadowRoot || n, 
 (BUILD.scoped || BUILD.shadowDom) && (scopeId = n["s-sc"]), BUILD.slotRelocation && (contentRef = n["s-cr"], 
 ...
 e.$queuedListeners$ = void 0)), emitLifecycleEvent(o, "componentWillLoad"), BUILD.cmpWillLoad && (l = safeCall(s, "componentWillLoad"))) : (emitLifecycleEvent(o, "componentWillUpdate"), 
 ...
 if (BUILD.isDev && (e.$flags$ |= 1024), BUILD.hydrateServerSide ? await callRender(e, t, s, o) : callRender(e, t, s, o), 
 ...
 if (BUILD.asyncLoading && a && (a.map((e => e())), s["s-rc"] = void 0), r(), l(), 
 BUILD.asyncLoading) {
...
const callRender = (e, t, o, n) => {
 const s = !!BUILD.allRenderFn, l = !!BUILD.lazyLoad, a = !!BUILD.taskQueue, r = !!BUILD.updatable;
 try {
  if (renderingRef = t, t = (s || t.render) && t.render(), r && a && (e.$flags$ &= -17), 
  (r || l) && (e.$flags$ |= 2), BUILD.hasRenderFn || BUILD.reflect) if (BUILD.vdomRender || BUILD.reflect) {
   if (BUILD.hydrateServerSide) return Promise.resolve(t).then((t => renderVdom(e, t, n)));
   renderVdom(e, t, n);
 ...
 n(), BUILD.asyncLoading && (e.$onReadyResolve$(o), l || appDidLoad(t))), BUILD.method && BUILD.lazyLoad && e.$onInstanceResolve$(o), 
 BUILD.asyncLoading && (e.$onRenderResolve$ && (e.$onRenderResolve$(), e.$onRenderResolve$ = void 0), 
 ...
 if (BUILD.member && t.$members$) {
  ...
  if (s.map((([e, [n]]) => {
   (BUILD.prop || BUILD.state) && (31 & n || (!BUILD.lazyLoad || 2 & o) && 32 & n) ? Object.defineProperty(l, e, {
    get() {
    ...
    configurable: !0,
    enumerable: !0
   }) : BUILD.lazyLoad && BUILD.method && 1 & o && 64 & n && Object.defineProperty(l, e, {
    value(...t) {
    ...
    plt.jmp((() => {
     ...
     if (this.hasOwnProperty(a)) s = this[a], delete this[a]; else {
      ...
      if (null == a) {
       ...
       if (!(8 & l) && 128 & l && s !== n) {
        const l = BUILD.lazyLoad ? o.$hostElement$ : this, a = BUILD.lazyLoad ? o.$lazyInstance$ : l, r = t.$watchers$[e];
        null == r || r.forEach((t => {
 ...
 if (0 == (1 & plt.$flags$)) {
  ...
  1 & t.$flags$) addHostEventListeners(e, t, o.$listeners$, !1), (null == t ? void 0 : t.$lazyInstance$) ? fireConnectedCallback(t.$lazyInstance$) : (null == t ? void 0 : t.$onReadyPromise$) && t.$onReadyPromise$.then((() => fireConnectedCallback(t.$lazyInstance$))); else {
   let n;
 ...
 BUILD.lazyLoad && BUILD.disconnectedCallback && safeCall(e, "disconnectedCallback"), 
 ...
 if (0 == (1 & plt.$flags$)) {
  ...
  BUILD.lazyLoad ? (null == t ? void 0 : t.$lazyInstance$) ? disconnectInstance(t.$lazyInstance$) : (null == t ? void 0 : t.$onReadyPromise$) && t.$onReadyPromise$.then((() => disconnectInstance(t.$lazyInstance$))) : disconnectInstance(e);
 }
 ...
 e.prepend = function(...e) {
  e.forEach((e => {
   ...
   const o = e["s-sn"] = getSlotName(e), n = getHostSlotNode(this.childNodes, o);
   if (n) {
    const t = document.createTextNode("");
    t["s-nr"] = e, n["s-cr"].parentNode.__appendChild(t), e["s-ol"] = t;
 ...
 e.insertAdjacentHTML = function(e, o) {
  ...
  let s;
  if (n.innerHTML = o, "afterbegin" === e) for (;s = n.firstChild; ) this.prepend(s); else if ("beforeend" === e) for (;s = n.firstChild; ) this.append(s);
 };
 ...
 e.insertAdjacentElement = function(e, o) {
  return "afterbegin" !== e && "beforeend" !== e ? t.call(this, e, o) : "afterbegin" === e ? (this.prepend(o), 
  o) : "beforeend" === e ? (this.append(o), o) : o;
 };
 ...
 BUILD.shadowDom && !supportsShadow && 1 & o.$flags$ && (o.$flags$ |= 8), BUILD.patchPseudoShadowDom && BUILD.scoped ? patchPseudoShadowDom(e.prototype, o) : (BUILD.slotChildNodesFix && patchChildSlotNodes(e.prototype, o), 
 BUILD.cloneNodeFix && patchCloneNode(e.prototype), BUILD.appendChildSlotFix && patchSlotAppendChild(e.prototype), 
 BUILD.scopedSlotTextContentFix && patchTextContent(e.prototype, o));
 ...
 if (e.map((e => {
  e[1].map((o => {
   ...
   BUILD.member && (r.$members$ = o[2]), BUILD.hostListener && (r.$listeners$ = o[3]), 
   BUILD.reflect && (r.$attrsToReflect$ = []), BUILD.watchCallback && (r.$watchers$ = null !== (n = o[4]) && void 0 !== n ? n : {}), 
   BUILD.shadowDom && !supportsShadow && 1 & r.$flags$ && (r.$flags$ |= 8);
   const i = BUILD.transformTagName && t.transformTagName ? t.transformTagName(r.$tagName$) : r.$tagName$, d = class extends HTMLElement {
    constructor(e) {
     super(e), registerHost(e = this, r), BUILD.shadowDom && 1 & r.$flags$ && (BUILD.hydrateServerSide || "shadowRoot" in e || (e.shadowRoot = e));
    }
    connectedCallback() {
   ...
   BUILD.patchPseudoShadowDom && BUILD.scoped ? patchPseudoShadowDom(d.prototype, r) : (BUILD.slotChildNodesFix && patchChildSlotNodes(d.prototype, r), 
   BUILD.cloneNodeFix && patchCloneNode(d.prototype), BUILD.appendChildSlotFix && patchSlotAppendChild(d.prototype), 
   BUILD.scopedSlotTextContentFix && patchTextContent(d.prototype, r)), BUILD.formAssociated && 64 & r.$flags$ && (d.formAssociated = !0), 
   BUILD.hotModuleReplacement && (d.prototype["s-hmr"] = function(e) {
    ((e, t, o) => {
     const n = getHostRef(e);
     n.$flags$ = 1, initializeComponent(e, n, t);
    })(this, r);
   }), r.$lazyBundleId$ = e[0], l.includes(i) || a.get(i) || (s.push(i), a.define(i, proxyComponent(d, r, 1)));
  }));
...
}, consoleError = (e, t) => (customError || defaultConsoleError)(e, t), consoleDevError = (...e) => {}, consoleDevWarn = (...e) => {}, consoleDevInfo = (...e) => {}, setErrorHandler = e => customError = e, plt = {
 $flags$: 0,
 $resourcesUrl$: "",
 jmp: e => e(),
